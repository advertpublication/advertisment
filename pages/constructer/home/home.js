...
Page({
  ...
  getConstructerList(start) {
    ...
    return httpPostNew(url, params).then(res => {
      ...
      wx.setStorageSync('constructionStationFlag', res.obj);
      ...
      this.setData({
        ...
        buildingcount: res.buildingcount,
        start: start,
        constructionStationFlag:wx.getStorageSync('constructionStationFlag'),//洽谈状态
      });
      return Promise.resolve();
    });
  },
